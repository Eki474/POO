...
Carte::Carte(Couleur c, Figure v, Joueur* j) : _couleur(c), _figure(v)
{
	_joueur = j;
}
Carte::Carte(Couleur c, Figure v, Joueur* j, Carte* s) : _couleur(c), _figure(v)
{
	_joueur = j;
	_suivante = s;
}
Carte::Carte(Couleur c, Figure v, Carte* s) : _couleur(c), _figure(v)
{
	_suivante = s;
}
...
Joueur* Carte::getJoueur() const
{
	return _joueur;
}
void Carte::setJoueur(Joueur* j)
{
	_joueur = j;
}